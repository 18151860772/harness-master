...
def compare_part_features_v2(master_file, diff_file, output_file):
    """
    比对零件号之间的功能差异（基于●标记）
    输出格式与技术差异输入文件一致（5列）
    ...
    # 获取功能列（从"标配"列之后开始）
    # "标配"列在索引243，从索引244开始是功能配置列
    feature_columns = master_df.columns[244:].tolist()
...
if __name__ == "__main__":
    ...
    # 执行比对
    compare_part_features_v2(master_file, diff_file, output_file)
